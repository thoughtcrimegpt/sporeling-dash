...
export const ROUTE_WAYPOINTS = {
  ...
  "THE PALE ROOT": [
    ...
    // Go around the checkpoint shelf instead of jumping into its underside.
    { name: "crossing left lip", x: 3.5 * 16, y: 118 * 16 - 10, rx: 16, ry: 8 },
    { name: "mercy side ledge", x: 8 * 16, y: 118 * 16 - 10, rx: 18, ry: 12, grounded: true },
    { name: "mercy right approach", x: 8 * 16, y: 116 * 16 - 10, rx: 16, ry: 16 },
    ...
    { name: "teeth left entry", x: 3 * 16, y: 90 * 16 - 10, rx: 24, ry: 16 },
    { name: "teeth right runway", x: 22.5 * 16, y: 90 * 16 - 10, rx: 24, ry: 16, grounded: true },
