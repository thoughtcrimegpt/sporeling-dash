  ...
  function createSporelingMenus(options) {
    ...
    function title() {
      ...
      return '<section class="sd-card sd-title-card">' +
        ...
        optionsSection() +
        '<p class="sd-hint">' + (v.touch ? "Tap an option. Your adventure starts with Play." : "Move with arrows or stick · Confirm with Enter, A, or tap") + '</p>' + (v.fullscreenMessage ? '<p class="sd-hint">' + text(v.fullscreenMessage) + '</p>' : '') +
        '</section>';
    }
    function pause() {
      var v = state;
