...
(function (root) {
  ...
  const layouts = {
    ...
    3: { w: 30, h: 56, notes: "A vertical garden with alternating bloom shelves, a glide pocket, and a calm gardener landing before the crown.", build: ({ set, rect }) => {
      rect(0, 0, 0, 55); rect(29, 0, 29, 55); rect(1, 54, 28, 55);
      rect(3, 48, 10, 48); rect(19, 43, 26, 43); rect(5, 38, 13, 38); rect(16, 33, 24, 33);
      rect(3, 28, 10, 28); rect(18, 23, 26, 23); rect(6, 18, 14, 18); rect(15, 13, 23, 13); rect(4, 8, 11, 8); rect(18, 3, 27, 3);
      set(4, 47, "P"); set(26, 2, "G"); set(8, 37, "C"); set(5, 37, "B"); set(22, 42, "B"); set(8, 32, "B"); set(22, 22, "B"); set(9, 17, "B"); set(20, 12, "B");
      for (const [c, r, ch] of [[12, 47, "e"], [18, 42, "f"], [14, 32, "e"], [11, 22, "f"], [18, 12, "e"]]) set(c, r, ch);
    } },
    4: { w: 100, h: 12, notes: "A bright canopy sprint with three short committed spans and a sheltered alcove for the keepsake.", build: ({ set, rect }) => {
      rect(0, 0, 99, 1); rect(0, 0, 0, 11); rect(99, 0, 99, 11); rect(1, 10, 13, 11); rect(86, 10, 98, 11);
      rect(17, 8, 24, 8); rect(29, 5, 35, 5); rect(40, 8, 48, 8); rect(53, 4, 60, 4); rect(65, 8, 73, 8); rect(78, 5, 84, 5);
      set(4, 9, "P"); set(94, 9, "G"); set(21, 7, "B"); set(32, 4, "B"); set(44, 7, "B"); set(56, 3, "B"); set(69, 7, "B"); set(81, 4, "B"); set(30, 3, "K");
      for (const [c, r, ch] of [[14, 9, "e"], [27, 7, "f"], [39, 7, "e"], [63, 7, "f"], [76, 7, "e"], [88, 9, "f"]]) set(c, r, ch);
    } },
    ...
    11: { w: 176, h: 30, movers: [{ c0: 58, c1: 62, rA: 24, rB: 13, period: 3.6, phase: 0.2 }], notes: "Three long rain crossings alternate with visible truffle islands, moving shelves, and a midpoint reset ledge.", build: ({ set, rect, seg }) => {
      rect(0, 0, 0, 29); rect(175, 0, 175, 29); rect(1, 27, 20, 29); rect(155, 27, 174, 29);
      seg(1, 20, 24); seg(35, 49, 20); seg(65, 78, 25); seg(94, 109, 18); seg(124, 139, 23); seg(153, 174, 20);
      rect(23, 22, 27, 22); rect(52, 15, 56, 15); rect(81, 20, 86, 20); rect(111, 13, 116, 13); rect(141, 18, 146, 18);
      for (const [c, r] of [[29, 25], [30, 25], [58, 25], [59, 25], [87, 25], [88, 25], [117, 25], [118, 25]]) set(c, r, "q");
      for (const [c, r, ch] of [[24, 20, "f"], [32, 22, "w"], [51, 18, "e"], [61, 24, "f"], [79, 22, "w"], [90, 21, "e"], [110, 16, "f"], [120, 22, "w"], [142, 18, "e"], [149, 19, "f"], [28, 23, "f"], [43, 20, "f"], [68, 22, "f"], [98, 19, "f"], [128, 18, "f"], [158, 16, "f"]]) set(c, r, ch);
    ...
    13: { w: 178, h: 30, movers: [{ c0: 80, c1: 85, rA: 23, rB: 12, period: 3.8, phase: 0.7 }], notes: "Heartroot is the restoration climax: three sustained enemy chains, two recovery shelves, then the Mother's door.", build: ({ set, rect, seg }) => {
      ...
      rect(21, 21, 26, 21); rect(50, 14, 55, 14); rect(79, 18, 85, 18); rect(109, 11, 114, 11); rect(139, 15, 145, 15);
      set(5, 23, "P"); set(168, 17, "G"); set(91, 15, "C");
      for (const [c, r, ch] of [[25, 21, "f"], [31, 22, "e"], [50, 17, "w"], [59, 22, "f"], [80, 21, "e"], [90, 15, "w"], [110, 14, "f"], [120, 21, "e"], [141, 17, "w"], [149, 17, "f"]]) set(c, r, ch);
      for (const [c, r] of [[28, 23], [43, 20], [68, 22], [98, 19], [128, 18], [158, 16]]) set(c, r, "f");
      for (const [c, r] of [[25, 24], [55, 18], [85, 22], [115, 19], [145, 17]]) set(c, r, "q");
  ...
  function createSporelingCampaign({ buildLevel, levels }) {
    ...
    return {
      ...
      apply() {
        ...
        // The rebuilt Skitterway places its mercy perch one tile above the
        // canopy shelf, keeping the retry marker in open air.
